...
(function() {
    const API_URL = 'http://85.192.60.226/api/config.php';
    let currentConfig = {};
    ...
    const icons = {
        ...
        firefox: `<svg viewBox="0 0 48 48"><path fill="#FF9500" d="M24 4C24 4 38 8 42 20C42 20 45 28 38 38C38 38 32 44 24 44C16 44 10 38 10 38C3 28 6 20 6 20C10 8 24 4 24 4Z"/><path fill="#FF0000" d="M24 10C24 10 34 12 36 20C36 20 38 26 34 32"/><circle cx="24" cy="24" r="10" fill="#20123A"/></svg>`, // Óïðîùåííûé ëîãîòèï
